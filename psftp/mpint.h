 ...
 */
static __inline mp_int *mp__from_string_literal( const char *lit )
{
 ...
 */
void mp_select_into( mp_int *dest, mp_int *src0, mp_int *src1, unsigned choose_src1 );
 ...
 */
typedef void ( *random_read_fn_t )( prng *, void *, size_t );
mp_int *mp_random_bits_fn( prng *pr, size_t bits, random_read_fn_t randfn );
mp_int *mp_random_in_range_fn( prng *pr, mp_int *lo_inclusive, mp_int *hi_exclusive, random_read_fn_t randfn );
#define mp_random_bits( pr, bits )			mp_random_bits_fn( pr, bits, random_read )
#define mp_random_in_range( pr, lo, hi )	mp_random_in_range_fn( pr, lo, hi, random_read )
