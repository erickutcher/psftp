...
//#define sfree( x )		do{ safefree( x ); x = NULL; }while( 0 )
...
#define sresize( ptr, n, type )		TYPECHECK( ( type * )0 == ( ptr ), ( ( type * )snrealloc( ( ptr ), ( n ), sizeof( type ) ) ) )
 ...
 */
void *safegrowarray( void *array, size_t *size, size_t eltsize, size_t oldlen, size_t extralen, bool _private );

/* The master macro wrapper, of which all others are special cases */
#define sgrowarray_general( type, array, size, n, m, priv )	( ( array ) = ( type )safegrowarray( array, &( size ), sizeof( *array ), n, m, priv ) )

/* The special-case macros that are easier to use in most situations */
#define sgrowarrayn(    t, a, s, n, m ) sgrowarray_general( t, a, s, n, m, false )
#define sgrowarray(     t, a, s, n    ) sgrowarray_general( t, a, s, n, 1, false )
#define sgrowarrayn_nm( t, a, s, n, m ) sgrowarray_general( t, a, s, n, m, true )
#define sgrowarray_nm(  t, a, s, n    ) sgrowarray_general( t, a, s, n, 1, true )
