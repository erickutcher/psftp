...
static void blowfish_encrypt( uint32_t xL, uint32_t xR, uint32_t *output, BlowfishContext *ctx )
{
	uint32_t *S0 = ctx->S0;
	uint32_t *S1 = ctx->S1;
	uint32_t *S2 = ctx->S2;
...
static void blowfish_decrypt( uint32_t xL, uint32_t xR, uint32_t *output, BlowfishContext *ctx )
{
	uint32_t *S0 = ctx->S0;
	uint32_t *S1 = ctx->S1;
	uint32_t *S2 = ctx->S2;
...
/*static void blowfish_lsb_encrypt_cbc( unsigned char *blk, int len, BlowfishContext *ctx )
{
...
static void blowfish_lsb_decrypt_cbc( unsigned char *blk, int len, BlowfishContext *ctx )
{
	uint32_t xL, xR, out[ 2 ], iv0, iv1;
...
static void blowfish_msb_encrypt_cbc( unsigned char *blk, int len, BlowfishContext *ctx )
{
	uint32_t xL, xR, out[ 2 ], iv0, iv1;
...
static void blowfish_msb_decrypt_cbc( unsigned char *blk, int len, BlowfishContext *ctx )
{
	uint32_t xL, xR, out[ 2 ], iv0, iv1;
...
static void blowfish_msb_sdctr( unsigned char *blk, int len, BlowfishContext *ctx )
{
...
void blowfish_expandkey( BlowfishContext *ctx, const void *vkey, short keybytes, const void *vsalt, short saltbytes )
{
	...
	for ( i = 0; i < 18; i++ )
	{
		P[ i ] ^= ( ( uint32_t )( unsigned char )( key[ ( i * 4 + 0 ) % keybytes ] ) ) << 24;
		P[ i ] ^= ( ( uint32_t )( unsigned char )( key[ ( i * 4 + 1 ) % keybytes ] ) ) << 16;
		P[ i ] ^= ( ( uint32_t )( unsigned char )( key[ ( i * 4 + 2 ) % keybytes ] ) ) << 8;
...
static void blowfish_setkey( BlowfishContext *ctx, const unsigned char *key, short keybytes )
{
...
{
	struct blowfish_ctx *ctx = container_of( cipher, struct blowfish_ctx, ciph );
	blowfish_setkey( &ctx->context, ( unsigned char * )key, ctx->ciph.vt->padded_keybytes );
}
...
{
	struct blowfish_ctx *ctx = container_of( cipher, struct blowfish_ctx, ciph );
	blowfish_lsb_encrypt_cbc( ( unsigned char * )blk, len, &ctx->context );
}

static void blowfish_ssh1_decrypt_blk( ssh_cipher *cipher, void *blk, int len )
{
	struct blowfish_ctx *ctx = container_of( cipher, struct blowfish_ctx, ciph );
	blowfish_lsb_decrypt_cbc( ( unsigned char * )blk, len, &ctx->context );
}*/
