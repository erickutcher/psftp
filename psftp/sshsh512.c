...
#define Maj( r, t, x, y, z )	( and( r, x, y ), and( t, x, z ), xor( r, r, t ), and( t, y, z ), xor( r, r, t ) )
#define bigsigma0( r, t, x )	( rorL( r, x, 28 ), rorB( t, x, 34 ), xor( r, r, t ), rorB( t, x, 39 ), xor( r, r, t ) )
#define bigsigma1( r, t, x )	( rorL( r, x, 14 ), rorL( t, x, 18 ), xor( r, r, t ), rorB( t, x, 41 ), xor( r, r, t ) )
#define smallsigma0( r, t, x )	( rorL( r, x, 1 ), rorL( t, x, 8 ), xor( r, r, t ), shrL( t, x, 7 ), xor( r, r, t ) )
#define smallsigma1( r, t, x )	( rorL( r, x, 19 ), rorB( t, x, 61 ), xor( r, r, t ), shrL( t, x, 6 ), xor( r, r, t ) )
...
static void SHA512_BinarySink_write( BinarySink *bs, const void *p, size_t len );
