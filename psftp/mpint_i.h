...
#define BignumCarry BignumInt

__inline void _BignumADC( BignumInt &ret, BignumCarry &retc, BignumInt a, BignumInt b, BignumCarry c )
{
	BignumDblInt ADC_temp = ( BignumInt )( a );
	ADC_temp += ( BignumInt )( b );
	ADC_temp += ( c );
...
__inline void _BignumMUL( BignumInt &rh, BignumInt &rl, BignumInt a, BignumInt b )
{
	BignumDblInt MUL_temp = ( BignumInt )( a );
	MUL_temp *= ( BignumInt )( b );
	( rh ) = ( BignumInt )( MUL_temp >> BIGNUM_INT_BITS );
...
__inline void _BignumMULADD( BignumInt &rh, BignumInt &rl, BignumInt a, BignumInt b, BignumInt addend )
{
	BignumDblInt MUL_temp = ( BignumInt )( a );
	MUL_temp *= ( BignumInt )( b );
	MUL_temp += ( BignumInt )( addend );
...
__inline void _BignumMULADD2( BignumInt &rh, BignumInt &rl, BignumInt a, BignumInt b, BignumInt addend1, BignumInt addend2 )
{
	BignumDblInt MUL_temp = ( BignumInt )( a );
	MUL_temp *= ( BignumInt )( b );
	MUL_temp += ( BignumInt )( addend1 );
...
#define BignumADC( ret, retc, a, b, c )						_BignumADC( ret, retc, a, b, c )
#define BignumMUL( rh, rl, a, b )							_BignumMUL( rh, rl, a, b )
#define BignumMULADD( rh, rl, a, b, addend )				_BignumMULADD( rh, rl, a, b, addend )
#define BignumMULADD2( rh, rl, a, b, addend1, addend2 )		_BignumMULADD2( rh, rl, a, b, addend1, addend2 )

#endif*/ /* _64BIT_NO_INTRINSICS_ */
